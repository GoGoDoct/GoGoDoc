...
range_for 는 (하한, 상한) 튜플 반환 - 범위 밖이면 classification 이 주의/이상 판정
...
REFERENCE: dict[str, dict] = {
    ...
    "크레아티닌": {
        "ranges": {"male": (0.7, 1.4), "female": (0.5, 1.1)},
        "unit": "mg/dL",
    ...
    # 혈액
    "헤모글로빈": {
        "ranges": {"male": (13, 17), "female": (12, 16)},
        "unit": "g/dL",
