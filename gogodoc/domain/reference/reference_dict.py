...
REFERENCE: dict[str, dict] = {
    ...
    # 갑상선 (종합검진 추가)
    "TSH": {
        "ranges": [_adult(0.4, 4.0)],
        "unit": "uIU/mL",
        "explanation": "뇌하수체가 분비하는 갑상선 자극 호르몬으로, 갑상선 기능을 보는 선별 지표",
        "caution": "높으면 기능저하·낮으면 기능항진 의심 - 유리T4 등과 함께 해석, 추적 권장",
        "source": "대한갑상선학회 갑상선기능검사 권고",
    },
    # 혈액 - CBC 보강 (종합검진 추가)
    "백혈구": {
        "ranges": [_adult(4000, 10000)],
        "unit": "/uL",
        "explanation": "감염·염증에 반응하는 면역 세포 수치",
        "caution": "상승 시 감염·염증, 저하 시 면역 저하 가능 - 추적 권장",
        "source": "서울아산병원 의료정보 일반혈액검사",
    },
    "혈소판": {
        "ranges": [_adult(150, 450)],
        "unit": "10^3/uL",
        "explanation": "지혈에 관여하는 혈액 세포 수치",
        "caution": "저하 시 출혈 경향, 과다 시 혈전 위험 - 추적 권장",
        "source": "서울아산병원 의료정보 일반혈액검사",
    },
    # 종양표지자 (종합검진 추가) - 단독 진단 의미 약함, 상한만 의미
    # TODO: D2 국립암센터·검사실 기준치 검수, 연령·흡연 보정
    "CEA": {
        "ranges": [_adult(0, 5)],
        "unit": "ng/mL",
        "explanation": "대장암 등에서 오를 수 있는 종양표지자로, 단독으로 진단하지 않는 선별 보조 지표",
        "caution": "흡연·양성 질환으로도 상승 - 단독 진단 불가, 상승 시 영상·내시경 등 정밀검사로 확인",
        "source": "국립암센터 종양표지자 안내",
    },
    "AFP": {
        "ranges": [_adult(0, 10)],
        "unit": "ng/mL",
        "explanation": "간암 등에서 오를 수 있는 종양표지자로, 단독으로 진단하지 않는 선별 보조 지표",
        "caution": "간염·임신 등으로도 상승 - 단독 진단 불가, 상승 시 영상 등 정밀검사로 확인",
        "source": "국립암센터 종양표지자 안내",
    },
    "CA19-9": {
        "ranges": [_adult(0, 37)],
        "unit": "U/mL",
        "explanation": "췌장·담도암 등에서 오를 수 있는 종양표지자로, 단독으로 진단하지 않는 선별 보조 지표",
        "caution": "담도 질환 등으로도 상승 - 단독 진단 불가, 상승 시 영상 등 정밀검사로 확인",
        "source": "국립암센터 종양표지자 안내",
    },
    "PSA": {
        "ranges": [_adult(0, 4, "male")],
        "unit": "ng/mL",
        "explanation": "전립선 관련 종양표지자로, 단독으로 진단하지 않는 선별 보조 지표(주로 남성)",
        "caution": "전립선비대·염증으로도 상승 - 단독 진단 불가, 상승 시 비뇨의학과 정밀검사 권장",
        "source": "국립암센터 종양표지자 안내",
    },
}
